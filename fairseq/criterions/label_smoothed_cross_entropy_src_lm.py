...
class LabelSmoothedCrossEntropySrcLMCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        src_lm_loss, src_lm_nll_loss = self.compute_loss(model, net_output[1]['enc_out'], sample['net_input']['src_tokens'], reduce=reduce)

        loss = (loss + src_lm_loss) / 2
        nll_loss = (nll_loss + src_lm_nll_loss) / 2
