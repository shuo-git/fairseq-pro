...
@register_model("transformer_joint")
class TransformerJointModel(FairseqEncoderDecoderModel):
    """
    Transformer joint model from Layer-wise Coordination
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return TransformerJointEncoder(args, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return TransformerJointDecoder(
            args,
            tgt_dict,
            embed_tokens,
...
class TransformerJointEncoder(FairseqEncoder):
    """
...
class TransformerJointDecoder(FairseqIncrementalDecoder):
    """
